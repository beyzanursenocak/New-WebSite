<template>
  ...
  >
    ...
    light
      color="#F4F9F4"
    >
      <v-toolbar-title color="#F6F4EB">Certificates</v-toolbar-title>
  ...
  <v-row dense>
    ...
    >
      <v-card style="background-color: #d6ddd6;">
        ...
        ></nuxt-img>
        <v-card-actions>
          <v-btn :aria-label="certificate.title" style="background-color: #5C8D89;">
