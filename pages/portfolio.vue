...
export default {
  ...
  data: () => ({
    projects: [
      { title: 'Cryptocurrency', src: 'Cryptocurrency.png', icon: 'mdi-chart-line' , link: 'https://github.com/Firdesbeyzanur/Cryptocurrency' , text: 'Cryptocurrency exchange tracking in a table with information pulled from the API.' , flex: 4 , show: false, categories: ['Vue.js', 'All'] },
      { title: 'Food Blog', src: 'Food Blog.png', icon: 'mdi-food' , link: 'https://github.com/Firdesbeyzanur/Food-App' , text: 'A blog with dessert recipes.' , flex: 4 , show: false, categories: ['Vue.js', 'All'] },
      { title: 'CarTrader', src: 'CarTrader.png', icon: 'mdi-car' , link: 'https://github.com/Firdesbeyzanur/CarTrader' , text: 'It\'s an app for buying a car. More useful with filtering feature.' , flex: 4 , show: false, categories: ['Vue.js', 'All'] },
      { title: 'Find the Hulk', src: 'Find the Hulk.png', icon: 'mdi-cat' , link: 'https://github.com/Firdesbeyzanur/Hulku-Bul' , text: 'It\'s a sticky memory game for my cat. Guess what\'s on the face-down card.' , flex: 4 , show: false, categories: ['Vue.js', 'All']  },
      ...
      { title: 'Form List', src: 'Form List.png', icon: 'mdi-account-key' , link: 'https://github.com/Firdesbeyzanur/Form' , text: 'Form application. Enter your information, click on the button and your information will come back on the card.' , flex: 4 , show: false, categories: ['Vue.js', 'All'] },
      { title: 'Number App', src: 'Number App.png', icon: 'mdi-code-equal' , link: 'https://github.com/Firdesbeyzanur/Nuxt-RandomNumber' , text: 'An application to generate random comma and whole numbers.' , flex: 4 , show: false, categories: ['Nuxt.js', 'All'] },
      { title: 'Blog', src: 'Blog.png', icon: 'mdi-gmail' , link: 'https://github.com/Firdesbeyzanur/WebSite' , text: 'I was asked for a blog page. A blog with a login page and admin login.' , flex: 4 , show: false, categories: ['Vue.js', 'All'] },
      { title: 'Card App - 1', src: 'Card App - 1.png', icon: 'mdi-newspaper' , link: 'https://github.com/Firdesbeyzanur/Card-App-4' , text: 'A card app with additional features in the edit section with description section and change image section.' , flex: 4 , show: false, categories: ['Vue.js', 'All'] },
      { title: 'Card App - 2', src: 'Card App - 2.png', icon: 'mdi-arrange-bring-forward' ,  link: 'https://github.com/Firdesbeyzanur/Card-App-3' , text: 'A card app with a description section and an edit section.' ,flex: 4 , show: false, categories: ['Vue.js', 'All'] },
      ...
      { title: 'Face Matching', src: 'Face Matching.png', icon: 'mdi-account-circle' , link: 'https://github.com/Firdesbeyzanur/Yuz-Eslestirme' , text: 'Face matching of the people in the database was done using MATLAB.' , flex: 4 , show: false, categories: ['MATLAB', 'All'] },
      { title: 'Prediction', src: 'Prediction.png', icon: 'mdi-account-multiple' , link: 'https://github.com/Firdesbeyzanur/Prediction-Classification' , text: 'A program that predicts people\'s age, gender and ethnicity with Python' , flex: 4 , show: false, categories: ['Python', 'All'] },
      { title: 'Mushroom Class', src: 'Mushroom Class.png', icon: 'mdi-mushroom' , link: 'https://github.com/Firdesbeyzanur/Mushroom-classification' , text: 'In this project, we will use the "Mushroom Classification" dataset, a public dataset from kaggle.com, and try to figure out whether a mushroom is edible or not.' , flex: 4 , show: false, categories: ['Python', 'All'] },
      { title: 'Insurance', src: 'Insurance - 2.png', icon: 'mdi-clipboard-account' , link: 'https://github.com/Firdesbeyzanur/GlobalAIHub-Project' , text: 'The insurance dataset was examined at the bootcamp organized by Global AI Hub.' , flex: 4 , show: false, categories: ['Python', 'All']},
      { title: 'Date Fruit', src: 'Date Fruit.png', icon: 'mdi-food-apple' , link: 'https://github.com/Firdesbeyzanur/Deep-Learning' , text: 'We created a neural network to classify dates with TensorFlow. For this, we used the "Date Fruit Dataset" available on Kaggle.' , flex: 4 , show: false, categories: ['Python', 'All'] },
      { title: 'Image Class', src: 'Image Class.png', icon: 'mdi-grid' , link: 'https://github.com/Firdesbeyzanur/CNN' , text: 'In this project, we built a convolutional neural network to solve a multi-class image classification problem.' , flex: 4 , show: false, categories: ['Python', 'All'] },
      { title: 'Movie Review', src: 'Movie Review.png', icon: 'mdi-movie' , link: 'https://github.com/Firdesbeyzanur/Deep-Learning_2' , text: 'Recurrent neural networks. IMDB Movie Review Dataset was used.' , flex: 4 , show: false, categories: ['Python', 'All']},
      { title: 'Puzzle', src: 'Puzzle.png', icon: 'mdi-puzzle' , link: 'https://github.com/Firdesbeyzanur/Lena512Disassembly' , text: 'Lena512 image split into 4 parts with MATLAB.' , flex: 4 , show: false, categories: ['MATLAB', 'All']},
      { title: 'Frame', src: 'Frame.png', icon: 'mdi-image-filter-frames' , link: 'https://github.com/Firdesbeyzanur/Lena512Frame' , text: 'We have the Lena512 picture in a black frame.' , flex: 4 , show: false, categories: ['MATLAB', 'All']},
      { title: 'Round Frame', src: 'Round Frame.png', icon: 'mdi-checkbox-blank-circle' , link: 'https://github.com/Firdesbeyzanur/Lena512RoundFrame' , text: 'We have enclosed the Lena512 picture in a black round frame.' , flex: 4 , show: false, categories: ['MATLAB', 'All']},
      { title: 'Resolution', src: 'Resolution.png', icon: 'mdi-file-image' , link: 'https://github.com/Firdesbeyzanur/Lena512Resolution' , text: 'We have output the Lena512 image in different resolutions.' , flex: 4 , show: false, categories: ['MATLAB', 'All']},
