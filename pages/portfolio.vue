...
export default {
  ...
  data: () => ({
    projects: [
      ...
      { title: 'Food Blog', src: 'Food.webp', icon: 'mdi-food' , link: 'https://github.com/Firdesbeyzanur/Food-App' , text: 'A blog with dessert recipes.' , flex: 4 , show: false, categories: ['Vue.js', 'All'] },
      ...
      { title: 'Form List', src: 'FormList.webp', icon: 'mdi-account-key' , link: 'https://github.com/Firdesbeyzanur/Form' , text: 'Form application. Enter your information, click on the button and your information will come back on the card.' , flex: 4 , show: false, categories: ['Vue.js', 'All'] },
      { title: 'Number App', src: 'NumberApp.webp', icon: 'mdi-code-equal' , link: 'https://github.com/Firdesbeyzanur/Nuxt-RandomNumber' , text: 'An application to generate random comma and whole numbers.' , flex: 4 , show: false, categories: ['Nuxt.js', 'All'] },
      ...
      { title: 'Card App - 1', src: 'CardApp1.webp', icon: 'mdi-newspaper' , link: 'https://github.com/Firdesbeyzanur/Card-App-4' , text: 'A card app with additional features in the edit section with description section and change image section.' , flex: 4 , show: false, categories: ['Vue.js', 'All'] },
      { title: 'Card App - 2', src: 'CardApp2.webp', icon: 'mdi-arrange-bring-forward' ,  link: 'https://github.com/Firdesbeyzanur/Card-App-3' , text: 'A card app with a description section and an edit section.' ,flex: 4 , show: false, categories: ['Vue.js', 'All'] },
      { title: 'Card App - 3', src: 'CardApp3.webp', icon: 'mdi-arrange-send-to-back' , link: 'https://github.com/Firdesbeyzanur/AddImageCard' , text: 'An application where you can upload up to 10 pieces with pictures and enter your information.' , flex: 4 , show: false, categories: ['Vue.js', 'All'] },
      { title: 'Card App - 4', src: 'CardApp4.webp', icon: 'mdi-arrange-bring-to-front' , link: 'https://github.com/Firdesbeyzanur/Card-App-2' , text: 'Click on the pen to open the edit section and edit it.' , flex: 4 , show: false, categories: ['Vue.js', 'All'] },
      { title: 'Card App - 5', src: 'CardApp5.webp', icon: 'mdi-multiplication-box' , link: 'https://github.com/Firdesbeyzanur/Card-App-1' , text: 'Edit the information on the card however you like.' , flex: 4 , show: false, categories: ['Vue.js', 'All'] },
      { title: 'Titanic', src: 'Titanic.webp', icon: 'mdi-qqchat' , link: 'https://github.com/Firdesbeyzanur/TitanicDataset' , text: 'In the Titanic dataset, data preprocessing was performed, ExtraTressClassifier and Feature Importance were extracted, SelectKBest was scored, correlation maps were created, non-normally distributed data were standardized and basic statistical information was extracted.' , flex: 4 , show: false, categories: ['Python', 'All'] },
      ...
      { title: 'Forecast Process', src: 'Forecast.webp', icon: 'mdi-account-convert' , link: 'https://github.com/Firdesbeyzanur/Tahminleme-Islemi' , text: 'Python code that predicts the age, race and gender of people after various operations.' , flex: 4 , show: false, categories: ['Python', 'All'] },
      { title: 'Face Matching', src: 'FaceMatching.webp', icon: 'mdi-account-circle' , link: 'https://github.com/Firdesbeyzanur/Yuz-Eslestirme' , text: 'Face matching of the people in the database was done using MATLAB.' , flex: 4 , show: false, categories: ['MATLAB', 'All'] },
      ...
      { title: 'Mushroom Class', src: 'Mushroom.webp', icon: 'mdi-mushroom' , link: 'https://github.com/Firdesbeyzanur/Mushroom-classification' , text: 'In this project, we will use the "Mushroom Classification" dataset, a public dataset from kaggle.com, and try to figure out whether a mushroom is edible or not.' , flex: 4 , show: false, categories: ['Python', 'All'] },
      { title: 'Insurance', src: 'Insruance2.webp', icon: 'mdi-clipboard-account' , link: 'https://github.com/Firdesbeyzanur/GlobalAIHub-Project' , text: 'The insurance dataset was examined at the bootcamp organized by Global AI Hub.' , flex: 4 , show: false, categories: ['Python', 'All']},
      { title: 'Date Fruit', src: 'DateFruit.webp', icon: 'mdi-food-apple' , link: 'https://github.com/Firdesbeyzanur/Deep-Learning' , text: 'We created a neural network to classify dates with TensorFlow. For this, we used the "Date Fruit Dataset" available on Kaggle.' , flex: 4 , show: false, categories: ['Python', 'All'] },
      { title: 'Image Class', src: 'ImageClass.webp', icon: 'mdi-grid' , link: 'https://github.com/Firdesbeyzanur/CNN' , text: 'In this project, we built a convolutional neural network to solve a multi-class image classification problem.' , flex: 4 , show: false, categories: ['Python', 'All'] },
      { title: 'Movie Review', src: 'Movie.webp', icon: 'mdi-movie' , link: 'https://github.com/Firdesbeyzanur/Deep-Learning_2' , text: 'Recurrent neural networks. IMDB Movie Review Dataset was used.' , flex: 4 , show: false, categories: ['Python', 'All']},
      ...
      { title: 'Round Frame', src: 'RoundFrame.webp', icon: 'mdi-checkbox-blank-circle' , link: 'https://github.com/Firdesbeyzanur/Lena512RoundFrame' , text: 'We have enclosed the Lena512 picture in a black round frame.' , flex: 4 , show: false, categories: ['MATLAB', 'All']},
